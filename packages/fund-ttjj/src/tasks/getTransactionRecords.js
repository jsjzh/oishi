...
const main = task_1.default.create('爬取操作记录');
main.execute(function (callback) {
    const helper = this.top.helper;
    const apiPath = path_1.default.resolve(helper.dayPath, 'GetTransactionRecords');
    const reqs = helper.allCode.map(({ code, name }) => (callback) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!data) {
            const rspData = yield service_1.GetTransactionRecords({ FundCode: code });
